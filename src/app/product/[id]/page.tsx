    ...
    <div className="bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-red-500/10 to-red-600/10 py-6 px-4">
        <div className="container mx-auto">
          <h1 className="text-2xl md:text-4xl font-bold text-center text-red-600 mb-3">🔥 FLASH SALE - 80% OFF 🔥</h1>
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="bg-red-100 text-red-600 px-3 py-1 rounded-full text-sm">⏰ Offer ends soon!</div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-gradient-to-r from-yellow-500/20 to-yellow-600/20 p-4 rounded-xl mt-4">
              ...
              <div className="text-sm text-yellow-700 mt-1 font-medium">Order now before price changes!</div>
            </div>
