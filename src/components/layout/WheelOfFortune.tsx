        ...
        <div className="relative p-4">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-lg text-emerald-600 font-semibold">{product.title}</p>
      ...
      <DialogContent className="sm:max-w-[800px] p-0">
        <DialogTitle>
          <div className="p-6 text-center relative overflow-hidden">
            ...
            <h2 className="text-2xl font-bold mb-2 animate-bounce">Spin & Win! 🎁</h2>
            ...
            <div className="absolute -left-10 top-1/2 h-8 w-40 bg-white/20 animate-[shine_2s_infinite]" />
          </div>
        </DialogTitle>
        ...
        <div className="flex flex-col items-center justify-center p-8 gap-4 bg-gray-50">
          ...
          >
            ...
            >
              {products.map((product, index) => (
                <div key={product._id} style={getSliceStyle(products.length, index)} className="absolute inset-0">
          ...
          >
            {hasSpun && !isSpinning && (
              <WinningItem product={products[winningIndex]} onClose={() => setIsOpen(false)} />
            )}
          </div>
