    ...
    <div key={`cart-item-${item.id}`} className="flex gap-4 p-4 hover:bg-gray-50">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-sm text-gray-500 mt-1">
          {isFreeItem ? <span className="text-emerald-600 font-medium">FREE</span> : formatPrice(item.price)}
        </div>
        <div className="flex items-center gap-3 mt-2">
          {isFreeItem ? (
            ...
            <>
              ...
              <button onClick={() => removeItem(item.id)} className="text-red-500 text-sm hover:text-red-600">
                Remove
              </button>
            </>
          )}
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between p-4 border-b bg-gray-50">
            <div className="flex items-center gap-2">
              ...
              <span className="bg-gray-200 px-2 py-1 rounded-full text-sm font-medium">{getTotalItems()}</span>
            </div>
